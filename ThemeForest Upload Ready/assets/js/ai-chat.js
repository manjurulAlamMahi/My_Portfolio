    ...
    var knowledgeBase = [
        {
            ...
            html:
                "<h3>Hey, I'm Alex's assistant 👋</h3>" +
                "<p>I can answer quick questions about Alex Morgan — a Full Stack Developer working remotely. Try asking about their <strong>services</strong>, <strong>projects</strong>, <strong>resume</strong> or how to <strong>get in touch</strong>.</p>"
        },
        {
            id: "about",
            keys: ["about", "who is alex", "bio"],
            html:
                "<h3>About Alex</h3>" +
                "<p>Alex is a Full Stack Developer who builds powerful products for people and businesses, working remotely with teams worldwide.</p>" +
                "<p>The focus is first-rate experiences — clean, dependable code across the full stack, from frontend to backend.</p>"
        },
        {
            id: "services",
            keys: ["service", "services", "offer", "what do you do"],
            html:
                "<h3>What Alex offers</h3>" +
                "<ul>" +
        ...
        },
        {
            ...
            html:
                ...
                "<p>Email: <a class=\"ai-inline-link\" href=\"mailto:hello@yourdomain.com\">hello@yourdomain.com</a><br>Skype: your.skype.id</p>" +
        ...
        },
        {
            ...
            html:
                ...
                "<p>I'm just a small on-page demo for now — ask me about Alex's <strong>about</strong>, <strong>services</strong>, <strong>projects</strong>, <strong>resume</strong> or <strong>contact</strong> details.</p>"
        }
    ];
